...
## ----fig1, fig.cap = "Visualization of the points from the data frame `df`", message = FALSE, warning = FALSE----
library(ggplot2)
ggplot(df, aes(x1, x2)) +
...
## ----fig4, echo = FALSE, message = FALSE, warning = FALSE, fig.cap = "Community cluster network for the tissue data. The line colors indicate the PaLD communities; the point colors indicate the tissue classification.", out.width = "100%"----
...
## ----fig5, fig.cap = "PaLD, k-means, and hierarchical 8-clustering of randomly generated example data (from \\citet{berenhaut2022social}; Figure 4D)."----
...
## ----figco, fig.cap = "A plot of cohesion versus distance for the data. The identified communities are colored as in Figure \\ref{fig:figculture}."----
