...
\title{Partitioned Local Depth (PaLD) Community Cluster Analyses in R}
...
clustering analyses, and creating data visualizations to display
community structure. We describe how to use the package as well as walk
...
\end{Sinput}
\begin{Soutput}
#> IGRAPH b2835f9 UNW- 6 3 -- 
#> + attr: name (v/c), weight (e/n)
#> + edges from b2835f9 (vertex names):
#> [1] A--B A--E D--F
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
#> + 8/87 vertices, named, from e40f165:
